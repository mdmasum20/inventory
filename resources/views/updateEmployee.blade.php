        ...
        <div class="col-sm-10">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <div class=" form">
                        <form class="cmxform form-horizontal tasi-form" id="newEmployeeForm" method="post" action="{{ url('/update-employee/'.$view_result->id) }}" novalidate="novalidate" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="form-group ">
                                ...
                                <div class="col-lg-10">
                                    <input class="form-control " id="experience" name="experience" type="text" value="{{ $view_result->experience }}">
                                </div>
                            </div>
                            <div class="form-group ">
                                <label for="email" class="control-label col-lg-2">Salary *</label>
                                <div class="col-lg-10">
                                    <input class="form-control " id="salary" name="salary" type="text" value="{{ $view_result->salary }}">
                                </div>
                            </div> 
                            <div class="form-group ">
                                <label for="email" class="control-label col-lg-2">Vacation *</label>
                                <div class="col-lg-10">
                                    <input class="form-control " id="vacation" name="vacation" type="text" value="{{ $view_result->vacation }}">
                                </div>
                            </div> 
                            <div class="form-group ">
