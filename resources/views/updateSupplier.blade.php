        ...
        <div class="col-sm-12">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <div class=" form">
                        <form class="cmxform form-horizontal tasi-form" id="newSupplierForm" method="post" action="{{ url('/update-supplier/'.$view_result->id) }}" novalidate="novalidate" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="form-group ">
                                <label for="email" class="control-label col-lg-3">Supplier Type</label>
                                <div class="col-lg-9">
