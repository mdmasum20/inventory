        ...
        <div class="col-sm-10">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <div class=" form">
                        <form class="cmxform form-horizontal tasi-form" id="newEmployeeForm" method="post" action="{{ url('/add-expense') }}" novalidate="novalidate" enctype="multipart/form-data">
                            @csrf
                            <div class="form-group ">
                                <label for="firstname" class="control-label col-lg-2">Expense Name *</label>
                                <div class="col-lg-10">
                                    <input class=" form-control" id="expense_name" name="expense_name" type="text">
                                </div>
                            </div>
                            <div class="form-group ">
                            ...
                            <div class="form-group ">
                                ...
                                <div class="col-lg-10">
                                    <input class="form-control " id="expense_amount" name="expense_amount" type="text">
                                </div>
                            </div>             
                            @if ($errors->any())
